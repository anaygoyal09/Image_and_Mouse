...
public class MouseMovingEx
{
	...
	public void runIt()
	{
		JFrame frame = new JFrame("Dragging an oval with a mouse");	// Creates a new JFrame called "Dragging an oval with a mouse"
		frame.setSize( 600, 600);	//Sets the size of the JFrame as 600, 600
...
class MouseMovingExPanel extends JPanel implements MouseMotionListener, MouseListener
{
	...
	public void mousePressed ( MouseEvent evt )
	{
		...
		if (xloc < xMouse && xMouse < (xloc + 50) && yloc < yMouse && yMouse < (yloc + 50) )
			dragging = true;
		if(xMouse<550&&xMouse>50&&yMouse<550&&yMouse>50)
		repaint();
	}
